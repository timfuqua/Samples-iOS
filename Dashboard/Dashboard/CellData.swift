...
//    }
    ...
    init(name: String, left1: String? = nil, right1: String? = nil, left2: String? = nil, right2: String? = nil, left3: String? = nil, right3: String? = nil, left4: String? = nil, right4: String? = nil) {
        self.name = name
        self.left1 = left1
        self.right1 = right1
        self.left2 = left2

...
func test02() {
  var myString = "String"
  var firstChar = myString.removeAtIndex(myString.startIndex)
  myString
}

func test03() {
  var myString = "String"
//  name.removeRange(name.startIndex..<advance(name.startIndex, 6))
  myString.removeRange(myString.startIndex..<advance(myString.startIndex, 2))
  myString
}
